...
final class CoreDataHelper {
    ...
    static func makeEmbeddedSocialInMemoryStack() -> CoreDataStack {
        let model = CoreDataModel(name: "EmbeddedSocial", bundle: Bundle(for: CoreDataModel.self), storeType: .inMemory)
