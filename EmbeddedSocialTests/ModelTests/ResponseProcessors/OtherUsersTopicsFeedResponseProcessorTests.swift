...
class OtherUsersTopicsFeedResponseProcessorTests: XCTestCase {
//    var cache: MockCache!
//    var predicateBuilder: MockTopicServicePredicateBuilder!
//    var sut: OtherUserFeedResponsePostProcessor!
//    
//    override func setUp() {
//        super.setUp()
//        cache = MockCache()
//        predicateBuilder = MockTopicServicePredicateBuilder()
//        sut = OtherUserFeedResponsePostProcessor(cache: cache, predicateBuilder: predicateBuilder)
//    }
//    
...
//        XCTAssertTrue(predicateBuilder.allTopicActionCommandsCalled)
//    }
}
