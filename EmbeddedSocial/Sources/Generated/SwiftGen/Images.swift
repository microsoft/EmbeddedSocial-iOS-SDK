...
enum Asset: String {
  ...
  case iconDotsDark = "icon_dots_dark"
  case iconDotsLight = "icon_dots_light"
  case iconEdit = "icon_edit"
  case iconGalleryDark = "icon_gallery_dark"
  case iconGalleryLight = "icon_gallery_light"
  ...
  case iconListDark = "icon_list_dark"
  case iconListLight = "icon_list_light"
